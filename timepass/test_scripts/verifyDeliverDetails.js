module.exports={
    ...
    'Delivery details'(browser) {
        ...
        browser
            ...
            // .windowMaximize()
            .pause(1000)
            .assert.containsText('//*[@id="content"]/div/main/section/div[1]/div/div/section[5]/div/div/div[1]/div[1]/a/div[2]/div[2]/span', "Delivered by 2nd Nov")
            .click('//*[@id="content"]/div/main/section/div[1]/div/div/section[5]/div/div/div[1]/div[1]/a/div[2]/h3')
            .pause(2000)
            .moveTo(null,200,300)
            .assert.containsText('//*[@id="content"]/div/main/section/div[1]/div/div/section/div/div/div/div[2]/div[3]/section/div[2]/div','Delivered by 2nd Nov')
